...
The improved preprocessing (Gaussian blur + histogram equalization) produced more stable and accurate detections, especially under poor lighting.

Adjusting scaleFactor and minNeighbors reduced false positives and produced a cleaner bounding box.

The bounding boxes were drawn correctly around the license plates, and cropped plate images were saved as output files.
